...
function Footer() {
  ...
  return (
    <footer className="footer">
      <p>&copy; {new Date().getFullYear()} Amarjeet Singh</p>
      <div className="footer-links">
        <a
          href="https://www.linkedin.com/in/amarjeet-singh-414a43284/"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://github.com/amarjeetsingh7503"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://www.instagram.com/amarjeet_singh7503?igsh=MXh6MmJzNTZvaTFtNQ%3D%3D&utm_source=qr"
          target="_blank"
          rel="noreferrer"
        >
